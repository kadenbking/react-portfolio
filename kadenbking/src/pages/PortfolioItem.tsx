...
import { FaAngleDoubleLeft, FaAngleDoubleRight, FaRegLightbulb } from "react-icons/fa";
    ...
    <React.Fragment>
      ...
      >
        ...
        <div className="mx-auto h-48 sm:h-64 md:h-72 lg:h-96 max-w-3xl w-3/4">
          <Carousel slide={false} leftControl={backButton} rightControl={nextButton}>
        ...
        <div className="flex flex-col">
          <div className="flex flex-row justify-center mt-6 mb-12">
            <Tooltip content="Click on image for larger preview" placement="bottom">
        ...
        <Modal show={imagePreview} position={"center"} size={"7xl"}>
          <Modal.Header onClick={() => setImagePreview(false)}>{project.title}</Modal.Header>
          <Modal.Body>
