...
export function getCardInformation(project: string): CardInformation {
  ...
  switch (project) {
    ...
    case "ncs":
      ...
      cardInformation.description = "Logo and Website redesign for local private school";
    ...
    case "wardgrove":
      ...
      cardInformation.description = "Static website redesign for a local Christmas Tree Farm";
      cardInformation.path = "wardgrove";
      break;
    case "evolve":
      cardInformation.img = evolve;
      cardInformation.title = "Evolve";
      cardInformation.description = "Album artwork redesign for school project";
...
export function getProject(item: string | undefined): PortfolioItem {
  ...
  switch (item) {
    case "thywordle":
      ...
      project.displayImgs = [
        { path: thy1, link: "https://thywordle.com" },
        { path: thy2, link: "http://thywordle.com" },
      ];
      project.description =
        "My senior capstone development project at Freed-Hardeman University, with extra hours spent developing accounts, groups, and other online features. Please visit to learn more!";
      project.next = "tfc";
      break;
    case "tfc":
      project.title = "Tate Faith & Co";
      project.displayImgs = [
        { path: tfcHome, link: "https://tatefaithco.com" },
        { path: tfcCategories, link: "http://tatefaithco.com" },
        { path: tfcShop, link: "http://tatefaithco.com/shop" },
        { path: tfcItem, link: "http://tatefaithco.com" },
        { path: tfcCart, link: "http://tatefaithco.com" },
      ];
    ...
    case "ncs":
      ...
      project.displayImgs = [
        { path: ncsRedesign, link: "https://neoshochristianschool.com/" },
        { path: ncsOriginal, link: "" },
      ];
      project.description =
        "Neosho Christian School asked me to update their logo and website. The logo was the result of sketching and pen tool work in Adobe Illustrator. The website was created with WordPress and the Divi theme. Before and after results are displayed below.";
    ...
    case "hillcrest":
      ...
      project.displayImgs = [
        { path: hillcrestRedesign, link: "https://neoshochurchofchrist.org/" },
        { path: w2w, link: "" },
        { path: vbs2022, link: "" },
        { path: fruitofthespirit, link: "" },
      ];
      project.description =
    ...
    case "cp":
      ...
      project.displayImgs = [
        { path: cpLayout, link: "https://competition-prediction.netlify.app/" },
        { path: cpExample, link: "http://competition-prediction.netlify.app/" },
      ];
      project.description =
        "This was my final class project in Advanced Web Design at Freed-Hardeman University. The assignment was to create a website from scratch redesigning the site of a local Christmas tree farm. Before and after results are displayed below.";
    ...
    case "wardgrove":
      ...
      project.displayImgs = [
        { path: wardgroveRedesign, link: "https://wardgrove.netlify.app/" },
        { path: wardgroveOriginal, link: "http://wardgrove.com/" },
      ];
      project.description =
        "This was my final project in Artificial Intelligence at Freed-Hardeman University. This web app uses a Python Flask API to return predictions from trained supervised learning models to a React frontend.";
      project.previous = "cp";
      project.next = "evolve";
      break;
    case "evolve":
      ...
      project.displayImgs = [
        { path: evolveMock, link: "" },
        { path: evolveFlat, link: "" },
      ];
      project.description =
        "An assignment for a Graphic Design class at Freed-Hardeman University. The goal was to redesign an album cover of choice and create professional mockup images for a CD cover and Vinyl case.";
    ...
    case "fhubound":
      ...
      project.description =
        "FHUBound is a cross-platform mobile app built with Microsoft's Xamarin by several Freed-Hardeman University students. The app is for prospective students to learn more about the University, schedule campus visits, and apply to FHU. I specifically spent a large amount of time on the rewards page.";
    ...
    case "piday":
      ...
      project.description =
        "I designed this sticker to promote an event for prospective students to experience a day on campus with the Computer Science department at Freed-Hardeman University. Students who attended received a Raspberry Pi and were taught how to use it by FHU professors and upperclassmen students.";
