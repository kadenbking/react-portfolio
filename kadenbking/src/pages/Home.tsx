...
function Home() {
  return (
    <React.Fragment>
      ...
      >
        <img src={me} alt="me" className="rounded-full w-3/5 md:w-2/5 max-w-sm mx-10 my-5" />
        <div className="flex flex-col justify-between items-center w-4/5 max-w-4xl m-10">
          ...
          <p className="text-lg text-darkBlue dark:text-white">
            Disciple of Christ. Writer of code. Designer, developer, and communicator. I love
            learning and problem solving, especially when it benefits and improves the lives of the
            people around me. Please feel free to contact me below if there is anything I can do for
            you.
          </p>
      ...
      >
        ...
        <div className="flex flex-col justify-between items-center w-4/5 max-w-4xl m-10">
          ...
          <p className="text-lg text-darkBlue dark:text-white">
            I have experience in UX Design, Visual Design, and Development work. I use a wide
            variety of design tools and applications including the Adobe Creative Suite. I am also
            familiar with several programming languages and frameworks and am able to pivot as the
            project requires. Use the links below to learn more about my work experience, education,
            and see samples of previous projects.
          </p>
